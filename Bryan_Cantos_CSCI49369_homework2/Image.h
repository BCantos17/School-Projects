...
class Image{
 private:
  ...
  int **image;
  void checkTopLeft( const Image *binary, int i, int j );
  void checkTop( const Image *binary, int i, int j, int & newLabel ); 
  void checkLeft( const Image *binary, int i, int j, int & newLabel );
  void checkAll( const Image *binary, int i, int j, int & newLabel );
  void notEqual( const Image *binary, int i, int j, int & newLabel, DisjSets & table );
...
*/
 ...
 void toLabel( const Image *binary );
